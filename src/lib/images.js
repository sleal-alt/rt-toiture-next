export const IMAGES = {
  ...
  hero: "/images/maison-apres-face.jpg",
  beforeAfter: "/images/chantier-apres-demoussage-velux.jpg",
  beforeAfterBefore: "/images/chantier-avant-demoussage-velux.jpg",
  zone: "/images/chantier-avant-demoussage-velux.jpg",
  artisan: "/images/artisan-toit.jpg",
};
...
export const SERVICE_IMAGES = {
  ...
  "revetement-hydrofuge-teinte": [
    ...
    { url: "/images/apres-hydrofugation-tuiles.jpg", alt: "Tuiles après revêtement hydrofuge teinté — aspect neuf Haute-Savoie", caption: "Teinte appliquée — aspect neuf garanti" },
  ...
  "couverture-toiture": [
    { url: "/images/chantier-demoussage-chalet-savoie.jpg", alt: "Chantier couverture toiture chalet Haute-Savoie — RT Toiture 74", caption: "Chantier de réfection — chalet savoyard" },
    { url: "/images/artisan-toit.jpg", alt: "Couvreur RT Toiture 74 en intervention sur toiture", caption: "Artisan en hauteur — intervention sécurisée" },
    { url: "/images/couvreur74-maison-renovee.jpg", alt: "Résultat réfection couverture toiture Haute-Savoie", caption: "Résultat final — couverture rénovée" },
